...
to be pedantic about terminology, these are the requested cross-validation
errors, i.e. the errors on the reserved validation set.  The term
cross-validation also appeared above in the context of parameters used with
caret's train and trainControl functions.  That usage of
"cross-validation" and this are unrelated -- caret does its own internal
cross-validation, and the models themselves are likely doing cross-validation
as well as part of their own training procedures.)
